...
function draw(){
    background(0); //1 186 240
//    var x=5; let y=50; const l=50;
    fill(100); //noFill();
    stroke(255,0,0); strokeWeight(3);
    //all of the functions before will be applicable for all if we don't define them for each
    rect(width/2,height/2,100,200); //vars width and height are already defined while creating the canvas
    fill(0,255,0);
    stroke(0,0,255); strokeWeight(3);
    ellipse(width*3/4,height-100,50,100);
    //console.log(frameRate());
    //frame changes its state 60 times in a second
}*/
